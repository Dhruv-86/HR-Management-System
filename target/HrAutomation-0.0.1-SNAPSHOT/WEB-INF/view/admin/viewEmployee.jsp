								...
								<div class="col-12">
									...
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<f:forEach items="${employeeList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.firstName}</td>
														<td>${i.lastName}</td>
														...
														<td><a href="editEmployee?id=${i.employeeTableId}"><i
																class="mdi mdi-pencil "></i></a> <a
															href="deleteEmployee?id=${i.employeeTableId}"><i
																class="mdi mdi-delete lead text-danger ml-1 "></i></a></td>
													</tr>
												</f:forEach>
											</tbody>
										</table>
