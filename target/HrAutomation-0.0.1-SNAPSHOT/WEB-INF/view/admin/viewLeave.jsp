								...
								<div class="col-12">
									...
									<%@taglib prefix="f" uri="http://java.sun.com/jstl/core_rt"%>
										<table id="order-listing" class="table">
											...
											<f:forEach items="${leaveCriteriaList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.leaveType}</td>
													<td>${i.days}</td>
													<td>${i.leavedescription}</td>
													<td><a href="editLeave?id=${i.id}"><i class="mdi mdi-pencil "></i></a>
													<a href=  "deleteLeave?id=${i.id}"><i class="mdi mdi-delete lead text-danger ml-1 "></i></a></td>
												</tr>
												</f:forEach>
											</tbody>
										</table>
