								...
								<div class="col-12">
									...
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<f:forEach items="${payrollList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.designationVO.designationName}</td>
													<td>${i.basicSalary}</td>
													
													<td><a href="editPayroll?id=${i.id}"><i class="mdi mdi-pencil "></i></a>
													<a href=  "deletePayroll?id=${i.id}"><i class="mdi mdi-delete lead text-danger ml-1 "></i></a></td>
												</tr>
												</f:forEach>
											</tbody>
										</table>
