								...
								<div class="col-12">
									...
									<%@taglib prefix="f" uri="http://java.sun.com/jstl/core_rt"%>
										<table id="order-listing" class="table">
											...
											<tbody>
											<f:forEach items="${designationList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.designationName}</td>
													<td>${i.designationDescription}</td>
													<td><a href="editDesignation?id=${i.id}"><i class="mdi mdi-pencil "></i></a>
													<a href=  "deleteDesignation?id=${i.id}"><i class="mdi mdi-delete lead text-danger ml-1 "></i></a></td>
												</tr>
												</f:forEach>
											</tbody>
										</table>
