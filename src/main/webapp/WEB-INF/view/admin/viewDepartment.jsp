								...
								<div class="col-12">
									<div class="table-responsive">
										...
										<table id="order-listing" class="table">
											...
											<tbody>
											<f:forEach items="${departmentList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.departmentName}</td>
													<td>${i.departmentDescription}</td>
													<td><a href="editDepartment?id=${i.id}"><i class="mdi mdi-pencil "></i></a>
													<a href=  "deleteDepartment?id=${i.id}"><i class="mdi mdi-delete lead text-danger ml-1 "></i></a></td>
												</tr>
												</f:forEach>
											</tbody>
										</table>
