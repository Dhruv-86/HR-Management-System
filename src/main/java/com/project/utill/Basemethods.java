...
public class Basemethods {
	...
	public static String generatePaySlip(EmployeeVO employeeVO, AttendenceVO attendanceVO, String path,
			String basicSalary, List allowanceList, List deductionList) {
	...
	public static String uploadIntoS3(File file, String employeeId) {
		...
		AmazonS3Client s3Client = new AmazonS3Client(
				new BasicAWSCredentials("Access Key", "security key"));
